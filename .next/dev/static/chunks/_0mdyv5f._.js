...
"[project]/src/features/faq/components/FaqAccordionItem.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/faq/components/FaqSection.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$data$2f$faqData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/faq/data/faqData.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$components$2f$FaqAccordionItem$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/faq/components/FaqAccordionItem.jsx [app-client] (ecmascript)");
...
function FaqSection() {
    ...
    const [faqItems, setFaqItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$data$2f$faqData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FAQ_ITEMS"]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FaqSection.useEffect": ()=>{
            let isMounted = true;
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$content$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentService"].getFaqs().then({
                "FaqSection.useEffect": ({ items })=>{
                    if (!isMounted) return;
                    if (Array.isArray(items) && items.length > 0) {
                        setFaqItems(items);
                        setOpenFaqId(items[0]?.id ?? null);
                    } else {
                        setFaqItems(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$data$2f$faqData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FAQ_ITEMS"]);
                        setOpenFaqId(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$data$2f$faqData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FAQ_ITEMS"][0]?.id ?? 1);
                    }
                }
            }["FaqSection.useEffect"]).catch({
                "FaqSection.useEffect": ()=>{
                    if (!isMounted) return;
                    setFaqItems(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$data$2f$faqData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FAQ_ITEMS"]);
                    setOpenFaqId(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$data$2f$faqData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FAQ_ITEMS"][0]?.id ?? 1);
                }
            }["FaqSection.useEffect"]).finally({
                "FaqSection.useEffect": ()=>{
    ...
    const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FaqSection.useMemo[categories]": ()=>{
            ...
            faqItems.forEach({
                "FaqSection.useMemo[categories]": (item)=>{
            ...
            return Array.from(catMap.values()).sort({
                "FaqSection.useMemo[categories]": (a, b)=>{
        ...
        "FaqSection.useEffect": ()=>{
            if (categories.length > 0) {
                const exists = categories.some({
                    "FaqSection.useEffect.exists": (c)=>c.id === activeCategory
                }["FaqSection.useEffect.exists"]);
                if (!exists) {
    ...
    const filteredFaqs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FaqSection.useMemo[filteredFaqs]": ()=>{
            const getFaqNum = {
                "FaqSection.useMemo[filteredFaqs].getFaqNum": (item)=>{
            ...
            }["FaqSection.useMemo[filteredFaqs].getFaqNum"];
            const filtered = faqItems.filter({
                "FaqSection.useMemo[filteredFaqs].filtered": (item)=>{
            ...
            }["FaqSection.useMemo[filteredFaqs].filtered"]);
            return filtered.sort({
                "FaqSection.useMemo[filteredFaqs]": (a, b)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FaqSection.useEffect": ()=>{
            if (filteredFaqs.length > 0) {
                const exists = filteredFaqs.some({
                    "FaqSection.useEffect.exists": (item)=>item.id === openFaqId
                }["FaqSection.useEffect.exists"]);
                if (!exists) {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        !loading && filteredFaqs.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: [
                                                "Office Line ",
                                                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$company$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COMPANY_CONFIG"].phone
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/features/faq/components/FaqSection.jsx",
                                            lineNumber: 244,
...
_s(FaqSection, "iQjMdBOoQqGPmMwvnPcOAmjdkMA=", false, function() {
    return [
...
"[project]/src/features/faq/data/faqData.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/faq/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "FAQ_CATEGORIES",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$data$2f$faqData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FAQ_CATEGORIES"],
    "FAQ_ITEMS",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$data$2f$faqData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FAQ_ITEMS"],
    "FaqAccordionItem",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$components$2f$FaqAccordionItem$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FaqAccordionItem"],
    "FaqSection",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$components$2f$FaqSection$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FaqSection"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/features/faq/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$components$2f$FaqSection$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/faq/components/FaqSection.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$components$2f$FaqAccordionItem$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/faq/components/FaqAccordionItem.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$faq$2f$data$2f$faqData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/faq/data/faqData.js [app-client] (ecmascript)");
}),
"[project]/src/features/faq/index.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/faq/index.js [app-client] (ecmascript, next/dynamic entry)", (function(__turbopack_context__){

__turbopack_context__.n(__turbopack_context__.i("[project]/src/features/faq/index.js [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=_0mdyv5f._.js.map