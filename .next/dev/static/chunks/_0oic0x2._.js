...
"[project]/src/features/hotels/state/HotelsContext.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const HotelsStateContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
const HotelsDispatchContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
function HotelsProvider({ children, initialHotels = [] }) {
    _s();
    const [state, dispatch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReducer"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$hotels$2f$state$2f$hotelsReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hotelsReducer"], {
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$hotels$2f$state$2f$hotelsReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialHotelsState"],
        allHotels: initialHotels.length > 0 ? initialHotels : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$hotels$2f$state$2f$hotelsReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialHotelsState"].allHotels
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HotelsProvider.useEffect": ()=>{
            ...
            const isHotelRoute = [
                ...
                "HotelsProvider.useEffect.isHotelRoute": (path)=>pathname === path || pathname.startsWith('/hotels/') || pathname.startsWith('/our-hotels/')
            }["HotelsProvider.useEffect.isHotelRoute"]);
            if (!isHotelRoute) return;
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$hotel$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hotelService"].getHotels().then({
                "HotelsProvider.useEffect": (hotels)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HotelsStateContext.Provider, {
        value: state,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HotelsDispatchContext.Provider, {
            value: dispatch,
            children: children
        }, void 0, false, {
...
_s(HotelsProvider, "xunhbB/6cyvXSkvVrWmJHe+XQik=");
_c = HotelsProvider;
function useHotelsState() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(HotelsStateContext);
    if (context === null) {
        throw new Error('useHotelsState must be used within a HotelsProvider');
    }
    return context;
}
_s1(useHotelsState, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
function useHotelsDispatch() {
    _s2();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(HotelsDispatchContext);
    if (context === null) {
        throw new Error('useHotelsDispatch must be used within a HotelsProvider');
    }
    return context;
}
_s2(useHotelsDispatch, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "HotelsProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/hotels/state/hotelsReducer.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$api$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/api.types.ts [app-client] (ecmascript)");
;
const BASE_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE_URL || 'https://admin.worldtracktravel.com/api';
...
async function fetchWithTimeout(url, options, timeoutMs) {
    ...
    try {
        ...
        if (err.name === 'AbortError') {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$api$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"](`Request timed out after ${timeoutMs}ms`, undefined, url);
        }
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$api$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"](`Network error: ${err.message}`, undefined, url);
    } finally{
        clearTimeout(timer);
    }
}
async function apiClient(endpoint, options = {}) {
    ...
    if (!response.ok) {
        ...
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$api$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"](errMessage, response.status, url);
    }
    try {
        return await response.json();
    } catch  {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$api$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"]('Invalid JSON response from server', response.status, url);
    }
}
...
"[project]/src/services/hotel.service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchHotelListing(filters = {}) {
    try {
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])('/hotel/minRate', {
            filters
        }, {
            cache: "no-store"
        });
...
const hotelService = {
   ...
   */ async getHotelById (id) {
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/hotel/${id}`, {
                cache: "no-store"
            });
   ...
   */ async getHotelLookups () {
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])('/hotel/lookups', {
                cache: "no-store"
            });
   ...
   */ async getHotelRoomTypes (hotelId) {
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/hotel/room/type/${hotelId}`, {
                cache: "no-store"
            });
   ...
   */ async getHotelRoomRates (filters = {}) {
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])('/hotel/room/rate', filters);
            return Array.isArray(res.data) ? res.data : [];
        } catch  {
            return [];
        }
   ...
   */ async getHotelFaqs (filters) {
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])('/hotel/faqs', body, {
                cache: "no-store"
            });
            return Array.isArray(res.data) ? res.data : [];
        } catch  {
   ...
   */ async getCalculatorHotels (payload = {}) {
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])('/calculator/hotel', payload);
            return Array.isArray(res.data) ? res.data : [];
        } catch  {
            return [];
        }
   ...
   */ async getCalculatorRooms (payload = {}) {
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])('/calculator/room', payload);
            return Array.isArray(res.data) ? res.data : [];
        } catch  {
            return [];
        }
...
"[project]/src/types/api.types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_0oic0x2._.js.map