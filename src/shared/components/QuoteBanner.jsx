...
export function QuoteBanner() {
  const whatsappUrl = COMPANY_CONFIG.getWhatsAppUrl(
    'Hi World Track Aviation, I would like to request hotel rates.'
  );
        ...
        <div className="quote-callout-card">
          ...
          <div className="quote-callout-right">
            <a
              ...
              aria-label="Request hotel rates on WhatsApp"
            >
              <svg
                width="17"
                height="17"
