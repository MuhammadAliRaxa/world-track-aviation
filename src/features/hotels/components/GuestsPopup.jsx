...
/**
 * Reusable Guests selection popup with solid blue minus/plus buttons matching design.
 *
 * @param {Object} props
 * @param {boolean} props.isOpen - Whether the popup is visible
 * @param {Function} props.onClose - Callback to close popup
 * @param {Object} props.counts - { Adult: number, Child: number, Infant: number }
 * @param {Function} props.onUpdateCount - (type: string, delta: number) => void
 */
export function GuestsPopup({
  isOpen,
  onClose,
